...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>Boolean</td><td><ul><li><strong>true:</strong> the element is visible in current viewport.</li><li><strong>false:</strong> the element is NOT visible in current viewport.</li></ul></td></tr></tbody></table>

## Example

Within the next 10 seconds, you want to verify that the 'btn\_Login' button is visible in the current viewport.
