...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>Boolean</td><td><ul><li><strong>true:</strong> the element is present and visible.</li><li><strong>false:</strong> the element is NOT present.</li></ul></td></tr></tbody></table>

## Example

You want to verify 'btn\_Login' button to be visible in 10 seconds.
