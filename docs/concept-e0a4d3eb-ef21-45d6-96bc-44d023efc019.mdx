...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>Boolean</td><td><ul><li>true if the element is present within the timeout.</li><li>false if the element is NOT present within the timeout.</li></ul></td></tr></tbody></table>

## Example

You want to wait for 'btn\_Login' button to be present in 10s timeout.
