...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>String</td><td>The device OS version of the current active mobile device.</td></tr></tbody></table>
...
-   Manual view
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/mobile-get-device-os-version/image2017-3-3-143A03A54.png" />
