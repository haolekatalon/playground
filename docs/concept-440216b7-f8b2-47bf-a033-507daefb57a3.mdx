...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>boolean</td><td><ul><li><p><strong>true:</strong> the element is present and clickable.</p></li><li><strong>false:</strong> the element neither present or clickable.</li></ul></td></tr></tbody></table>
