...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>int</td><td>Left position of web element.</td></tr></tbody></table>

## Example

You want to get the left position of the object "txt\_UserName", then store it into "leftPosition" variable.
