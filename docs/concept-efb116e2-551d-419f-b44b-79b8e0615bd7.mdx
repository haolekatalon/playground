...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>Boolean</td><td><ul><li><p><strong>true</strong>if the actual number is less than the expected number.</p></li><li><p><strong>false</strong> if the actual number is NOT less than the expected number.</p></li></ul></td></tr></tbody></table>
