...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>int</td><td>Current viewport's height.</td></tr></tbody></table>

## Example

You want to get viewport height value of web browser. The output is stored in variable "viewport\_height".
