...
1.  [Understanding Your Application Under Test \(AUT\)](/create-tests/test-objects/web-test-objects/handling-web-element-locators-using-katalon-studio#)
2.  [Understanding Application Lifecycles](/create-tests/test-objects/web-test-objects/handling-web-element-locators-using-katalon-studio#)
3.  [Using Static Locators](/create-tests/test-objects/web-test-objects/handling-web-element-locators-using-katalon-studio#)
4.  [Using Uniquely Present Text](/create-tests/test-objects/web-test-objects/handling-web-element-locators-using-katalon-studio#)
5.  [Summary](/create-tests/test-objects/web-test-objects/handling-web-element-locators-using-katalon-studio#)
...
<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/tutorials/web_element_locators/Username.png" alt="Username" />
...
-   Locate the <code>//label[.='Username']//ancestor::div[1]</code>
-   Locate the <code>//label[.='Username']/following-sibling::input</code>
...
-   Id <code>//&lt;[@id='login-form-username']</code>
-   Name <code>//&lt;[@name='os&#95;username']</code>
-   Class <code>//&lt;[@class='text medium-field']</code>
-   Tag <code>//input[@class='text medium-field']</code>
-   Attribute <code>//input[@class='text medium-field'][@type='text']</code>
...
A label is usually used to describe a message \(error message, info message, hint message, etc.\), a control \(textbox, radio button, text area, etc.\), or a tooltip. As shown in the user interface, a label is usually unique—otherwise it would be confusing for users to differentiate UI elements. Therefore, the label's text is considered a good candidate of the label's locator. To make the locator more readable, can be used to narrow the scope of the locator.

To locate a label, you should focus on: tag and text. For example:

## Welcome to Jira

Xpath: //h2\[text\(\)='Welcome to Jira'\] //div\[.='Welcome to Jira'\] \| Priority Xpath: //label\[text\(\)='Priority'\] //label\[.='Priority'\] \| \| --- \| --- \|
...
-   There are some XPath that can be used to locate the textbox:
    ...
    -   <code>//label[.='Username']/following-sibling::input</code>

    -   <code>//label[.='Username']//ancestor::div[1]//input</code>

    -   <code>//input[@id=//label[.='Username']/@for]</code>

-   Sometimes you may see some textboxes that already have text \(or a placeholder\) inside them:<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/tutorials/web_element_locators/textboxes.png" alt="textboxes" />
...
Pay attention to the 'placeholder' attribute. It may be dynamic as well. The Search bar of Airbnb's website is an example:<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/tutorials/web_element_locators/Search-bar-of-Airbnbs.png" alt="Search-bar-of-Airbnb's" />
...
<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/tutorials/web_element_locators/examples-of-buttons-in-a-web-page-300x60.png" alt="examples-of-buttons-in-a-web-page" />
...
<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/tutorials/web_element_locators/the-text-in-the-button-300x92.png" alt="the-text-in-the-button" />
...
<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/tutorials/web_element_locators/Drop-down-list.png" alt="Drop-down-list" />
...
-   <code>//Select[@id=//label[.="Priority"]/@for]</code>

-   <code>//Select[.//option[.="Highest"]]</code>

-   <code>//option[.="Highest"]//ancestor::Select[1]</code>
...
<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/tutorials/web_element_locators/hyperlinks-locator.png" alt="hyperlink's-locator" />
...
-   <code>//a[@href="/secure/ForgotLoginDetails.jspa"]</code>

-   <code>//a[.="Can't access your account?"]</code>
...
<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/tutorials/web_element_locators/checkbox-locator.png" alt="checkbox-locator" />
...
-   <code>//label[.='Remember me']//preceding-sibling::input[1]</code>

-   <code>//label[.='Remember me']//ancestor::div[1]//input</code>

-   <code>//input[@id=//label[.="Remember me"]/@for]</code>

-   <code>//input[.//following-sibling::label[.='Remember me']]</code>
...
<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/tutorials/web_element_locators/radio-button.png" alt="radio-button" />
...
-   <code>//label[.='Accept License Agreement']//preceding-sibling::input[1]</code>

-   <code>//label[.='Accept License Agreement']//ancestor::div[1]//input</code>

-   <code>//input[@id=//label[.="Decline License Agreement"]/@for]</code>

-   <code>//input[.//following-sibling::label[.='Decline License Agreement']]</code>
