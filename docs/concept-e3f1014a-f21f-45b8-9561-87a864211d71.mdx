...
-   **Keyword syntax**: <code>WebUI.takeAreaScreenshot(fileName, rect, flowControl)</code>
-   **Parameters**:
...
3.  You want to take a screenshot of an area at x: 50, y: 25, width: 100, height: 150 and save it somewhere else:
