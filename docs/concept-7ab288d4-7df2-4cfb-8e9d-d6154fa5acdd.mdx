...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>boolean</td><td><ul><li><strong>true:</strong> the element is present and clickable.</li><li><strong>false:</strong> the element is neither present or clickable.</li></ul></td></tr></tbody></table>
