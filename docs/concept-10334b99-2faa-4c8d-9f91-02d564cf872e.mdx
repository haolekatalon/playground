...
1.  Download and extract Winium.Desktop.Driver.zip from the Winium.Desktop GitHub release page:[https://github.com/2gis/Winium.Desktop/releases](https://github.com/2gis/Winium.Desktop/releases) .
