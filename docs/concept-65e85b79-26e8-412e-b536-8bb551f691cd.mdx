...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>boolean</td><td><p>Result of verification:</p> <ul><li>true if the element is checked.</li><li>false if the element is unchecked.</li></ul></td></tr></tbody></table>
