...
-   **Keyword syntax**: <code>WebUI.takeFullPageScreenshot(fileName, ignoredElements, flowControl)</code>
-   **Parameters**:
...
1.  Given that no elements are going to be hidden, you want to take a full-page screenshot with a default name and use default [failure handling](https://docs.katalon.com/katalon-studio/docs/failure-handling.html):
...
2.  You want to take a full-page screenshot that will be saved in a file named 'full*view*no\_logo.png' in the report folder and hide some web elements:
...
3.  You want to take a full-page screenshot that will be saved to a file 'E:\\full*view*no\_elements.png' and hide some web elements defined in a variable named 'ignoredElements':
