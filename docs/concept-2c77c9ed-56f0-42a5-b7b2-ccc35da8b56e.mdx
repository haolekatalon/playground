...
-   You need to subscribe to Katalon Platform Ultimate plan. See: [TestOps Trial Plans](/administer/katalon-platform-packages/katalon-platform-plans).
...
-   Single sign-on SSO URL: <code>https://sso.katalon.io/saml/SSO</code>
-   SP Entity ID: <code>com:katalon:testops</code>
-   Attribute statement: <code>Email</code>
...
-   You have configured a Subdomain. See [Configure a Subdomain for an Organization](/administer/administration-tasks/organization-management/subdomain-configurations).

-   You have configured an identity provider for SSO in Katalon TestOps, see above: [Configure identity provider](/administer/administration-tasks/organization-management/single-sign-on-configurations#).
...
3.  Scroll down to the **Single Sign-On \(SSO\) Settings** section.
...
You can also enable SSO for the existing members of your Organization. To learn more about user management in TestOps, refer to this guide: [User Management](/administer/administration-tasks/user-management/manage-users).
...
2.  On the top-right corner of the **User Management** page, click on the **Invite User** button.
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-analytics/docs/testops-revamp-july-sso-settings/K1-User-Management-Active-User.png" alt="User Invitation Window" />

3.  In the displayed **User Invitation** window, insert the new User's email address.

    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-analytics/docs/testops-revamp-july-sso-settings/K1-User-Invitation-Window.png" alt="User Invitation Window" />

4.  In the **Login Settings** section, toggle on the **Log in to \[custom.katalon.io\] by Single Sign-On** option.

    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-analytics/docs/testops-revamp-july-sso-settings/K1-User-Management-Toggle-SSO.png" alt="User Invitation Window" />
...
2.  In the **Active Users** tab, nagivate to a User's row, click on the *more options* icon, and select **Edit Login Options**.
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-analytics/docs/testops-revamp-july-sso-settings/K1-User-Management-Active-Users-tab-more-options.png" alt="More options icon" />

3.  In the new **Login Settings** pop-up, toggle on the **Log in to \[custom.katalon.io\] by Single Sign-On** option.

    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-analytics/docs/testops-revamp-july-sso-settings/K1-Log-Settings-Username_Password-enabled.png" width={500} alt="SSO toggle turned on" />
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-analytics/docs/testops-revamp-july-sso-settings/K1-Login-Settings-Pending-Invitation-Link.png" width={500} alt="SSO toggle turned on" />
...
<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-analytics/docs/testops-revamp-july-sso-settings/K1-Pending-Invitations.png" alt="SSO toggle turned on" />
...
2.  Select the Users with SSO invitations that you want to revoke, then click on the **Revoke SSO** button.
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-analytics/docs/testops-revamp-july-sso-settings/K1-Revoke-SSO-button.png" alt="SSO toggle turned on" />

3.  In the **Revoke Single Sign-On Invitation** pop-up, verify the list of selected Users and click on the **Revoke SSO** button.

    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-analytics/docs/testops-revamp-july-sso-settings/K1-SSO-Revoke-Popup.png" alt="Revoke SSO pop-up" />
...
2.  Click on the *Profile* icon at the top right corner, and select **Deactivate**.
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-analytics/docs/testops-revamp-july-sso-settings/activate-sso-in-studio.png" alt="ks activation box" />
...
3.  Fill in the required information.
    ...
    -   **Password**: enter an API key generated in Katalon TestOps. See: [API Keys](/administer/settings/katalon-api-key-in-katalon-testops).
...
1.  Go to your email and find the *\[Katalon TestOps\] Verify Single Sign-On \(SSO\) authentication* email, then click **Click here to confirm** in the email.
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-analytics/docs/testops-revamp-july-sso-settings/K1-Accept-SSO-request.png" alt="user accept sso" />
...
2.  Check the information, then click **Yes, enable SSO** to confirm.
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-analytics/docs/testops-revamp-july-sso-settings/subdomain-signin-using-sso-blurred.png" alt="subdomain sign in using SSO" />
