...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>Boolean</td><td>true, if the device is in portrait mode; otherwise, false.</td></tr></tbody></table>
...
-   Manual view
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/mobile-verify-is-portrait/image2017-3-3-153A133A45.png" />
