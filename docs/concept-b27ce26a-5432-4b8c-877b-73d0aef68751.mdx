...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>int</td><td>width of web element.</td></tr></tbody></table>

## Example

You want to get the width of object "txt\_UserName" , then store it into "width" variable.
