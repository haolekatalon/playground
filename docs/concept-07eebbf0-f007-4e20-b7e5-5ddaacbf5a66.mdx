...
slug: /execute/ci-cd-integrations/bamboo-add-on
---
...
The Katalon Studio for Bamboo plugin enables you to download, deploy and execute Katalon Studio tests on Bamboo CI server automatically. Try it for free on [Atlassian Marketplace](https://marketplace.atlassian.com/apps/1220235/katalon-devops-for-bamboo).
...
3.  Click **Find new apps** from the left-hand side of the page.
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/bamboo-integration/find-apps.png" />
...
2.  Add **Execute Katalon Studio Tests** to your jobs of the newly created plan.
    ...
    -   Add **Execute Katalon Studio Tests** to your job list. <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/bamboo-integration/bamboo-tasktypes.png" />
3.  Configure the **Execute Katalon Studio Tests** task and click **Save** to create it.
    ...
    -   **Command Arguments**: you can enter the arguments directly in the text area or copy and paste the generated command from Katalon Studio.
        ...
        -   Please remove any irrelevant argument such as <code>-runmode</code>. See Command Arguments for more details.

        :::

        <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/bamboo-integration/command.png" />

        For the list of supported Katalon command syntax and how to generate command, please read more [here](/execute/katalon-runtime-engine/command-line-syntax-in-katalon-runtime-engine).
...
If you want to keep Katalon Studio artifact from the build, you can specify the **Copy Pattern** as <code>Reports/&lt;&lt;/&lt;.&lt;</code>

<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/bamboo-integration/bamboo-artifactdefinition.png" />

After a build, execution log files created by Katalon Studio are stored under the **Artifacts** tab.

<img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/bamboo-integration/bamboo-viewartifact.png" />