...
With iOS real device, you need to enable the **Web Inspector** to use this keyword. On your real iOS device, go to **Settings &gt; Safari &gt; Advanced**and enable **Web Inspector.**
...
-   Manual view
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/mobile-switch-to-web-view/image2017-3-3-143A493A21.png" />
