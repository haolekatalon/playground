...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>boolean</td><td><ul><li><strong>true:</strong> the element is present and is not visible.</li><li><strong>false:</strong> the element is not present, or the element is visible.</li></ul></td></tr></tbody></table>
