...
<table><tr><th>Param Type</th><th>Description</th></tr><tbody><tr><td>boolean</td><td><ul><li><strong>true:</strong> the element does NOT present.</li><li><strong>false:</strong>the element presents.</li></ul></td></tr></tbody></table>
